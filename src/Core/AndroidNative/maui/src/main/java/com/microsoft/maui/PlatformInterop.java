...
public class PlatformInterop {
    ...
    public static View getSemanticPlatformElement(View view) {
        if (view instanceof SearchView) {
            ...
            // Material3 SearchBar uses TextInputLayout with an inner TextInputEditText.
            // Redirect automation ID to the EditText so Appium can interact with it.
            android.widget.EditText editText = ((com.google.android.material.textfield.TextInputLayout) view).getEditText();
            if (editText != null) {
                view = editText;
            }
        }
