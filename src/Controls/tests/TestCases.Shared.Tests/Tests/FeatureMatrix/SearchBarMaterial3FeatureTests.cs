...
{
    public const string SearchBarMaterial3FeatureMatrix = "Search Bar Material3 Feature Matrix";

    public override string GalleryPageName => SearchBarMaterial3FeatureMatrix;
